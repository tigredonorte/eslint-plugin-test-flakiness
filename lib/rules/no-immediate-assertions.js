...
module.exports = {
  ...
  create(context) {
    ...
    function checkSequentialStatements(node) {
      // Only check within block statements or program body
      ...
      if (node.type === 'ExpressionStatement' && 
        ...
        if (nextStatement && 
          ...
          // Even if awaited, some actions need additional waitFor
    ...
    function getIndentation(node) {
      ...
      const lineStart = source.lines[token.loc.start.line - 1].match(/^\s*/);
